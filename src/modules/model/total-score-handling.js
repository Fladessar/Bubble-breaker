import { coordinatesOfBubblesForRemovingX } from './collect-data-for-bubbles-removing.js';
import { drawScore } from '../view/draw-score.js';
import { saveBestResult } from './best-result-handling.js';

export let totalScore = 0;

export let totalScoreHandling = (value) => {
